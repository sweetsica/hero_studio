...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('task_account_comments', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('task_id')->references('id')->on('task_accounts')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('task_account_comments');
    }
};
